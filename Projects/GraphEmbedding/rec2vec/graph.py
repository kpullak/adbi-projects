...
def records_to_graph():
    ...
    for key, value in movies.iteritems():
      currNode = Node(getNextnId(),value.name,'movie')
    ...
    for actor in list(actors):
      currNode = Node(getNextnId(),actor,'actor')
      nodedict[actor] = currNode
      nodelist.append(currNode)


    # adding director in the nodedict and nodelist
    for director in list(directors):
      currNode = Node(getNextnId(),director,'director')
      nodedict[director] = currNode
      nodelist.append(currNode)

    # adding genre in the nodedict and nodelist
    for genre in list(genres):
      currNode = Node(getNextnId(),genre,'genre')
      nodedict[genre] = currNode
      nodelist.append(currNode)  
